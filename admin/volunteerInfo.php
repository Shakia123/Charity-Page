...
<body>
                    ...
                    <tbody>
                        ...
                        while($row  = mysqli_fetch_assoc($res2)){
                            ...
                            <tr>
                                ...
                                <td><?php echo $pass; ?></td>
                                <td>
                                    <a href="editvolunteer.php?editid=<?php echo $id;?>"class="badge bg-success">Edit</a>
                                    <a href="volunteerinfo.php?delid=<?php echo $id;?>"class="badge bg-danger">Delete</a>
    ...
    if(isset($_GET['delid'])){
        ...
        $sql3 = "DELETE FROM volunteer WHERE id = '$delet_id'";
